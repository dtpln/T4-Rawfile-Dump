...
//TODO POSTPATCH INTEGRATION: need to switch to all of our attachments and weapons
		...
		{
			iprintln( "^1Warning: (" + self.name + ") special grenade " + special_grenade + " is invalid. Setting to  grenade." );
			special_grenade = molotovGrenadeIndex;
		}
...
initPerkDvars()
{
	...
	level.cac_fireproof_data = cac_get_dvar_int( "perk_fireproof", "55" );				// reduced flame damage by this %
	level.cac_armorvest_data = cac_get_dvar_int( "perk_armorVest", "75" );				// multipy damage by this %	
	level.cac_explosivedamage_data = cac_get_dvar_int( "perk_explosiveDamage", "25" );	// increased explosive damage by this %
	level.cac_flakjacket_data = cac_get_dvar_int( "perk_flakJacket", "75" );			// explosive damage is this % of original
