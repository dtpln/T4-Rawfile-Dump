...
onStartGameType()
{
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "capture", 30 );

	maps\mp\gametypes\_rank::registerScoreInfo( "defend", 0 );
	maps\mp\gametypes\_rank::registerScoreInfo( "defend_assist", 0 );
